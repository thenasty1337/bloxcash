      ...
      <div class={`games-sidebar ${props.gamesSidebar ? 'active' : ''} ${props.collapsed ? 'collapsed' : ''}`}>
        ...
        <div class="sidebar-content">
          ...
          <div class="games-card">
            ...
            <div class={`featured-games-list ${featuredExpanded() && !props.collapsed ? 'expanded' : ''}`}>
          ...
          <div class="games-card">
            ...
            <div class={`featured-games-list ${communityExpanded() && !props.collapsed ? 'expanded' : ''}`}>
          ...
          <div class="games-card">
            ...
            <div class={`featured-games-list ${legalExpanded() && !props.collapsed ? 'expanded' : ''}`}>
