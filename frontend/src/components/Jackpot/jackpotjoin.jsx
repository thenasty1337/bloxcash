  ...
  return (
    <>
      <div class='modal fadein' onClick={() => props.close()}>
        <div class='jackpot-create' onClick={(e) => e.stopPropagation()}>
          <div class='header'>
            ...
            <p class='title'><img src='/assets/icons/coin2.svg' height='20' alt=''/>JOIN JACKPOT</p>
